...
def main(CFG, data_path, batch_size, with_val=False):
    ...
    if with_val:
        ...
        val_loader = DataLoader(
            val_dataset, batch_size, shuffle=False, num_workers=12, pin_memory=True, drop_last=False)
    else:
        train_dataset = vessel_dataset(data_path, mode="training")
    train_loader = DataLoader(
        train_dataset, batch_size, shuffle=True, num_workers=12, pin_memory=True, drop_last=True)
